...
processor = SegformerImageProcessor.from_pretrained("segformer_finetuned")
segformer = SegformerForSemanticSegmentation.from_pretrained("segformer_finetuned").to(device)
print("SegFormer num_labels:", segformer.config.num_labels)
print("Classifier output shape:", segformer.decode_head.classifier.out_channels)
segformer.eval()
...
def predict():
    ...
    <h3>Uploaded MRI:</h3>
    <img src="/{STATIC_FOLDER}/{image_filename}" width="256"><br>
    <h3>SegFormer Mask (Colored):</h3>
    <img src="/{STATIC_FOLDER}/seg_rgb_{base_name}.png" width="256"><br>
    <ul>
    ...
    <h3>Overlay on MRI:</h3>
    <img src="/{STATIC_FOLDER}/overlay_{base_name}.png" width="256"><br>
